locals {
  ...
  aws_helloworld_function_package_local_path              = "./terraform/lambdas/helloworld/dist/index.zip"
  helloworld_function_package_base64sha256_local_path     = "${local.helloworld_function_package_local_path}.base64sha256"
  aws_helloworld_function_package_base64sha256_local_path = "${local.aws_helloworld_function_package_local_path}.base64sha256"
